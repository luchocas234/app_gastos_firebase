    ...
    <React.StrictMode>
      <AuthProvider>
        ...
        <BrowserRouter>
          ...
          <div className="bg-white w-[90%] m-auto max-w-[1200px] h-[95vh] lg:h-[90vh] lg:max-h-[800px] overflow-y-auto shadow-2xl rounded-lg flex flex-col justify-between relative z-20">
            <Routes>
